...
{
	syscall(SYS_env_set_priority,(int32) envID, priority,0,0,0);
...
void* sys_sbrk(int increment)
{
	...
	uint32 *p =(void*)syscall(SYS_sbrk,(uint32) increment,0 ,0 ,0 ,0);
	//cprintf("pointerr %x\n", (uint32*)p);
	return (uint32*)p;
...
//syscall
 // Define the function signature in syscall.c
